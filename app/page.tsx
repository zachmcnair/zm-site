  ...
  return (
    <>
      ...
      <section className="mb-16">
        ...
        <h2 className="text-xl md:text-2xl font-dm-mono text-gray-600 dark:text-gray-400 mb-2">
          BRAND & PRODUCT DESIGN CONSULTANT
        </h2>
        
        <p className="text-lg font-dm-mono text-gray-500 dark:text-gray-500 mb-6">
