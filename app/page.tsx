        ...
        <section className="mb-16 relative">
          ...
          <h2 className="text-xs font-dm-mono mb-6" style={{color: '#6b7280'}}>
            BRAND & PRODUCT DESIGN CONSULTANT
                ...
                <p className="text-xl leading-relaxed max-w-3xl mb-8 body-text">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="md:col-span-4">
              <div className="max-w-2xl">
                <p className="text-lg leading-relaxed mb-4 body-text">
              ...
              <div className="space-y-24 max-w-[540px]">
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 ml-4 experience-body-text">
                    ...
                    <li>A business incubator (Thinkubator) supporting WIN (on-chain gaming), Supermode.ls (creative tools you own), and Money.xyz (know your assets)</li>
                  </ul>
                </div>
              ...
              <div className="space-y-6">
                <div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                    ...
                    <div style={{color: '#fefcf4'}}>2012-Present</div>
                  </div>
                </div>
                ...
                <div>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-2">
                    ...
                    <div style={{color: '#fefcf4'}}>2021-Present</div>
                  </div>
                </div>
